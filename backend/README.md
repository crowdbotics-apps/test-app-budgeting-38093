...
## Project Structure
    ...
    ├── test_app_budgeting_38093  # Django project configurations
...
1. Clone this repo and `cd test_app_budgeting_38093`
...
2. Clone this repo and `cd test_app_budgeting_38093`
